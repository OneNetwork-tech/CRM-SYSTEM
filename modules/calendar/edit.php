...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($data['title'])) {
        ...
        // Update event
        $updated = $calObj->updateEvent($event_id, $data);
...
$end_date = $event['end_datetime'] ? date('Y-m-d', strtotime($event['end_datetime'])) : '';
$end_time = $event['end_datetime'] ? date('H:i', strtotime($event['end_datetime'])) : '';
?>
        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <form method="POST">
                    ...
                    <a href="view.php?id=<?php echo $event['id']; ?>" class="btn btn-secondary">Cancel</a>
                </form>
            </main>
        </div>
    </div>
