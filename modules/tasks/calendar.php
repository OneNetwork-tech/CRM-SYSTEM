...
// Group tasks by date for easier display
$tasksByDate = [];
...
<head>
    ...
    <title>Uppgiftskalender - <?php echo APP_NAME; ?></title>
        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Uppgiftskalender</h1>
                ...
                <div class="row mb-3">
                    <div class="col-md-12 text-center">
                        ...
                        <h3 class="d-inline mx-3"><?php echo date('F Y', $timestamp); ?></h3>
                ...
                <div class="calendar">
                    ...
                    for ($day = 1; $day <= $daysInMonth; $day++) {
                        ...
                        // Display up to 3 tasks per day
                        $taskCount = 0;
                        foreach ($dayTasks as $task) {
                            if ($taskCount >= 3) {
                                echo '<div class="calendar-task">+' . (count($dayTasks) - 3) . ' fler</div>';
                                break;
                            }
                            ...
                            echo '<div class="calendar-task ' . $taskClass . '" title="' . htmlspecialchars($task['title']) . '">';
                            echo '<a href="view.php?id=' . $task['id'] . '" class="text-white">';
                            echo htmlspecialchars(substr($task['title'], 0, 15)) . (strlen($task['title']) > 15 ? '...' : '');
                            echo '</a>';
                            echo '</div>';
