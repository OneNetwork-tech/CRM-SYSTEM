...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($data['title'])) {
        ...
        // Create project task
        $taskId = $projectObj->createTask($data);
        
        if ($taskId) {
            $success = 'Projektuppgift skapad';
            // Redirect to project view page after short delay
            header("refresh:2;url=view.php?id=$project_id");
        } else {
            $error = 'Kunde inte skapa projektuppgift. Försök igen.';
        }
    }
}
...
<head>
    ...
    <title>Lägg till projektuppgift - <?php echo APP_NAME; ?></title>
        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Lägg till projektuppgift</h1>
                    <div>
                        <h5>Projekt: <?php echo htmlspecialchars($project['name']); ?></h5>
                    </div>
                </div>
                ...
                <form method="POST">
                    ...
                    <button type="submit" class="btn btn-primary">Skapa projektuppgift</button>
